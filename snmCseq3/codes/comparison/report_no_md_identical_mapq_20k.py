...
def main() -> None:
    ...
    ap.add_argument("reference_fasta", help="Genomic mm10.fa")
    ...
    def process_row(rec: dict) -> dict | None:
        ...
        rb = count_non_md_cross_pipeline_pbat_nd_edit_distance(br, fa)
        ry = count_non_md_cross_pipeline_pbat_nd_edit_distance(yr, fa)
        ub = rb
        uy = ry
    ...
    with PdfPages(pdf_path) as pdf:
        ...
        fig.suptitle(
            "NM tag vs calculated mismatch (same no-MD method both BAMs)\n"
        ...
        fig.suptitle("Recomputed edit distributions (same no-MD method)", fontsize=11)
        fig.tight_layout()
        pdf.savefig(fig, dpi=150)
        plt.close(fig)
        ...
        _hist_pair(
            ...
            "bhmem calc",
            "yap calc",
            "MAPQ stratum: same no-MD method",
        )
        ...
        _hist_pair(
            ...
            "bhmem calc",
            "yap calc",
            "Diff locus subset: same no-MD method",
        )
        axes[1, 0].hist(
            su,
        ...
        axes[1, 1].text(
            ...
            "Single metric: count_non_md_cross_pipeline_pbat_nd_edit_distance\n"
