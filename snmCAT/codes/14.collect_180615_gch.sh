...
#SBATCH --job-name=gch_180615
#SBATCH --output=/gpfs/projects/b1042/epifluidlab/yoshii/scnomehic_paper/benchmark/snmCAT/codes/logs/14.gch_180615/collect.out
#SBATCH --error=/gpfs/projects/b1042/epifluidlab/yoshii/scnomehic_paper/benchmark/snmCAT/codes/logs/14.gch_180615/collect.err

# Per-cell HCG/GCH/HCH site counts + methylation from the 180615 --nome ALLC.
...
OUT="${BASE}/mapping_180615/stats/hcg_gch_nome.tsv"
mkdir -p "${BASE}/mapping_180615/stats" "${BASE}/codes/logs/14.gch_180615"

printf "cell_id\tHCG_site_count\tGCH_site_count\tHCH_site_count\tHCG_mc_rate\tGCH_mc_rate\tHCH_mc_rate\n" > "${OUT}"
for allc in "${BASE}"/mapping_180615/Group*/allc/*.allc.tsv.gz; do
