...
trim_galore --quality 30 --phred33 --illumina --stringency 1 -e 0.1 --clip_R1 6 --gzip --length 20 -j 8 -o ${outfolder_fq} --fastqc --fastqc_args "--outdir ${outfolder} -t 8" ${infolder}/${prefix}_1.fastq ${infolder}/${prefix}_2.fastq
echo "Trimming Done"
